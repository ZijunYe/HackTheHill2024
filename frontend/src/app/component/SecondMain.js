...
export default function SecondMain({ name, onSubmit }) {
  ...
  return (
    <div className="border-black border-8 rounded-xl grid items-center justify-items-center min-h-screen relative p-8">
      ...
      <div className="font-pixelify text-8xl text-black flex items-center mb-20">
          <h1>Hello, {name}</h1>
          <img src="/images/smileChat.png" alt="smile" className="ml-2" />
        </div>
      <div className="box bg-white border-black border-8 rounded-md shadow-md px-44 py-8 inline-block text-center relative">
        <img
