  ...
  return (
    <div className="min-h-screen p-6 flex justify-center">
            ...
            <div key={index}>
              <div className="flex justify-between items-center p-4 rounded-lg animate-moveIn">
                <div className="flex items-center space-x-4">
                  <div className="">
                    <img className="w-32" src={user.avatar} alt={`${user.name} avatar`} />
                  </div>
                  <div className="pl-10">
              ...
              {index < users.length - 1 && <hr className="border-t-4 border-gray-300 my-6" />}
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="absolute bottom-0 w-full flex px-10 animate-moveIn">
        <img className="w-40 pt-10 animate-move-loop" src="/images/moving/rabbit_walking.gif" alt="Moving Rabbit" />
      </div>
    </div>
  );
}
